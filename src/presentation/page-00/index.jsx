...
useGLTF.preload("/models/page-00/tag.gltf");
useTexture.preload("/models/page-00/bbva-band.png");
...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const { nodes, materials } = useGLTF("/models/page-00/tag.glb");
  const texture = useTexture("/models/page-00/bbva-band.png");
        ...
        >
          ...
          >
            ...
            <mesh
              castShadow
              receiveShadow
              geometry={nodes.bbva_footer_dkt_es.geometry}
              material={materials.bbva_footer_dkt_es}
              position={[-0.115, 0.923, 0.007]}
              rotation={[Math.PI / 2, 0, 0]}
              scale={0.103}
            />
          </group>
